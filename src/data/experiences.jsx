...
export const experiences = [
  ...
  },
  {
    ...
    description: [
      ...
      "Proficiently used Jira software to plan and execute Scrum sprints.",
      ...
      "Leveraged the React Native Async-storage library for persisting sensitive user information on the device.",
      "Collaborated with end-users to develop user acceptance test cases.",
    ],
    icon: <Wisconsin />,
    textColor: "#8C5348",
  },
  {
    ...
    description: [
      "Initiated the project by proposing a visionary idea that secured a place among the top 25 out of 200 projects for implementation.",
      ...
      "Made significant contributions to frontend logic and user interface using React Native and TypeScript.",
